...
An MCP (Model Context Protocol) server for **Zava Insurance** that exposes claims management tools and rich interactive widgets using the [OpenAI Apps SDK](https://developers.openai.com/apps-sdk). Compatible with any OpenAI Apps SDK-capable host such as ChatGPT and Microsoft 365 Copilot.
